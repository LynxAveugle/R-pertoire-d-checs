...
self.addEventListener("fetch",e=>{
  ...
  e.respondWith((async()=>{
    ...
    // Network-first keeps GitHub Pages from serving an old app after a deployment.
    if(cached){
