...
const js=fs.readFileSync('./stockfish/stockfish-18-lite-single.js');
const wasm=fs.readFileSync('./stockfish/stockfish-18-lite-single.wasm');
...
assert.match(sw,/stockfish\/stockfish-18-lite-single\.js/);
assert.match(sw,/stockfish\/stockfish-18-lite-single\.wasm/);
