...
assert.match(worker,/raw\.githubusercontent\.com\/solid-apps\/stockfish\/gh-pages\/vendor\/stockfish-18-lite-single\.js/,'Stockfish doit avoir un fallback GitHub');
assert.match(worker,/cdn\.jsdelivr\.net\/npm\/stockfish@18\.0\.8\/bin\/stockfish-18-lite-single\.js/,'Stockfish doit avoir un second fallback CDN');
